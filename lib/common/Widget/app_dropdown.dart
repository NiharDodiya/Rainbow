...
class AppDropdown extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<RegisterController>(id: 'register_screen',builder: (controller) {
      return Container(
        width: Get.width*0.3,
              ...
              children: [
                InkWell(onTap: () {
                  controller.statusController.text = paramList[index];
                    ...
                    child: Text(paramList[index],style: textStyleFont14Black,)),
...
class AppDropDownNoOfKids extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    RegisterController controller = Get.put(RegisterController());
    return GetBuilder<RegisterController>(id: RegisterController,builder: (controller) {
      return Container(
        width: Get.width*0.2,
        constraints: BoxConstraints(
          minHeight: Get.height * 0.0739,
...
class AppDroDownIdType extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<IdVerificationController>(id:  'register_screen',builder: (controller) {
      return Container(
        width: Get.width*0.3,
        constraints: BoxConstraints(
          minHeight: Get.height * 0.0739,
