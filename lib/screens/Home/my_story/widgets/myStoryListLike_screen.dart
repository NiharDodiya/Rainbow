                ...
                return Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      CachedNetworkImage(height: 56,
                        width: 56,
                        imageUrl: myStoryController.storyLikeList[index].profileImage.toString(),
                        imageBuilder: (context, imageProvider) =>
                            Container(
                              decoration: BoxDecoration(
                                shape: BoxShape.circle,
                      ...
                      Column(
                        ...
                        children: [
                          Text(
                            myStoryController.storyLikeList[index].fullName.toString(),
                            style: sfProTextReguler().copyWith(
                              fontSize: 13,
                              fontWeight: FontWeight.w700,
                              color: ColorRes.black,
                          ...
                          Text(
                            myStoryController.storyLikeList[index].userStatus.toString(),
                            style: sfProTextReguler().copyWith(
                              fontWeight: FontWeight.w300,
                              color: ColorRes.black,
                              fontSize: 11,
