...
class FriendStoryApi {
  ...
  static Future getMyPostList() async {
    ...
    try {
      ...
      http.Response? response = await HttpService.postApi(
          url: url, header: {"Content-Type":"application/json","x-access-token": accesToken});
  ...
  static Future createPost( BuildContext context, List listItems, String tittle,String description,
