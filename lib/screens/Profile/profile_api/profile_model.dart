...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
    ...
    userView: json["userView"] == null ? null : List<UserView>.from(json["userView"].map((x) => UserView.fromJson(x))),
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "visitors": visitors,
    "userView": userView == null ? null : List<dynamic>.from(userView!.map((x) => x.toJson())),
  };
}
