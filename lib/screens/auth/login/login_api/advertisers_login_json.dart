...
AdvertisersLoginModel advertisersLoginModelFromJson(String str) => AdvertisersLoginModel.fromJson(json.decode(str));

String advertisersLoginModelToJson(AdvertisersLoginModel data) => json.encode(data.toJson());
...
class AdvertisersLoginModel {
  ...
  factory AdvertisersLoginModel.fromJson(Map<String, dynamic> json) => AdvertisersLoginModel(
    status: json["status"],
