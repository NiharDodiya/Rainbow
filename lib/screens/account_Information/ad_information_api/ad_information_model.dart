...
AdInformationModel adInformationModelFromJson(String str) => AdInformationModel.fromJson(json.decode(str));

String adInformationModelToJson(AdInformationModel data) => json.encode(data.toJson());
...
class AdInformationModel {
  ...
  factory AdInformationModel.fromJson(Map<String, dynamic> json) => AdInformationModel(
    status: json["status"],
