...
//
//     final storyViewListModel = storyViewListModelFromJson(jsonString);

import 'dart:convert';

StoryViewListModel storyViewListModelFromJson(String? str) =>
    StoryViewListModel.fromJson(json.decode(str!));

String? storyViewListModelToJson(StoryViewListModel data) =>
...
class StoryViewListModel {
  ...
  factory StoryViewListModel.fromJson(Map<String, dynamic> json) =>
      StoryViewListModel(
        status: json["status"],
