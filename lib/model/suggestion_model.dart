...
class SuggestionModel {
  ...
  factory SuggestionModel.fromJson(Map<String, dynamic> json) => SuggestionModel(
    ...
    count: json["count"],
    data: json["data"] == null ? null : List<SuggestionUser>.from(json["data"].map((x) => SuggestionUser.fromJson(x))),
  );
...
class SuggestionUser {
  ...
  factory SuggestionUser.fromJson(Map<String, dynamic> json) => SuggestionUser(
    id: json["id"],
